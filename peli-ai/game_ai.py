...
class MC_node:
    ...
    def is_leaf(self):
        ...
        if not self.has_branches():
            ...
            if self.winner == 0: 
                ...
                # If there are no following plays, the game has ended in a draw.
    ...
    def explore_branches(self):
        ...
        # if this is a leaf, just return this node
        # todo
        
        # search as long as we haven't found a leaf
        while not active_node.is_leaf():

            # Move down the tree as long as no leaf is found.
            # Always save the node you travel to in active_node.
            
            # todo
            pass
            
        # eventually, return the found leaf node
        return active_node
...
if __name__ == "__main__":
    ...
    # play the game
    # choose number of players and their type, and set AI thinking time
    winner = play_game([HUMAN,CPU], thinking_time = 1000)
